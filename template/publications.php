...
<a class="menu-toggle mobile-visible">
    <i class="fa fa-bars"></i>
                ...
                <div class=" col-xs-12 col-sm-12 ">
                  ...
                  <div id="portfolio_content_q" class="portfolio-content">
                    ...
                    <ul class="portfolio-filters">
                      ...
                      <li>
                        <a class="filter btn btn-sm btn-link" id="button_books">Book Chapters</a>
                      </li>
      ...
      <script src="publications_articles.js"></script>
      <script src="publications_books.js"></script>
      <script src="publications_conferences.js"></script>
      <script src="publications_journals.js"></script>
      <script src="publications_news.js"></script>
