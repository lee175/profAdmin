! function(r) {
    ...
    function s() {
        ...
        var o = r(".ajax-page-load").each(function() { if (o = r(this).attr("href"), location.hash == location.hash.split("/")[0] + "/" + o.substr(0, o.length - 5)) { var e = r(this).attr("href"); return t(), a.load(e), !1 } });
        r(document).on("click", "#ajax-page-close-button", function(e) { e.preventDefault(), r("#page-ajax-loaded").addClass("fadeOutLeft closed"), r("body").removeClass("ajax-page-visible"), setTimeout(function() { r("#page-ajax-loaded.closed").html(""), a.hide() }, 500), location.hash = location.hash.split("/")[0] }).on("click", ".ajax-page-load", function() { var e = location.hash.split("/")[0] + "/" + r(this).attr("href").substr(0, r(this).attr("href").length - 5); return location.hash = e, t(), !1 })
    }

    function d() { 150 < r(i).scrollTop() ? r(".lmpixels-scroll-to-top").removeClass("hidden-btn") : r(".lmpixels-scroll-to-top").addClass("hidden-btn") }

    function jix() { 75 < r(i).scrollTop() ? r(".lmpixels-navbar").removeClass("hidden-btn") : r(".lmpixels-navbar").addClass("hidden-btn") }
    r(function() {
        ...
        var e, a, t;
        r(".preloader").fadeOut(800, "linear"), e = r(window).width(), a = "", t = r("#page_container").attr("data-animation"), (a = r(991 < e ? ".page-container" : ".site-main")).addClass("animated " + t), r(".page-scroll").addClass("add-prespective"), a.addClass("transform3d"), setTimeout(function() { r(".page-scroll").removeClass("add-prespective"), a.removeClass("transform3d") }, 1e3)
    }).on("hashchange", function(e) { location.hash && s() }), r(document).on("ready", function() {
        ...
        r("body").on("mousemove", function(e) {
            ...
            s.addClass("transition"), s.css({ "background-position": "calc( 50% + " + o + "px ) calc( 50% + " + i + "px )" }), setTimeout(function() { s.removeClass("transition") }, 300)
        }).scroll(function() { d(), jix() });
        var e = r(".portfolio-grid"),
            a = r("#portfolio-gallery-grid");
        a.imagesLoaded(function() { a.masonry() }), e.imagesLoaded(function() {
